        ...
        <div id="conteudo_especifico">
            <div class="div_central centralizar">
                ...
                <?php
						...
						$sql_registro_venda = "INSERT INTO venda
												(dataVenda, idFuncionario_FK)
												VALUES ('$data','$idFun')";
						...
						$sql_consulta_ultima_venda = "SELECT idVenda
						FROM venda ORDER BY idVenda DESC LIMIT 1";
						
						$resultado_consulta = mysqli_query ($conectar, $sql_consulta_ultima_venda);		
												
						$registro_idVenda = mysqli_fetch_row ($resultado_consulta);
						
						
						$sql_consulta = "Select  cerveja.idCerveja ,cerveja.nomeCerveja, carrinho.quantidade , cerveja.preco from cerveja 
							INNER JOIN carrinho on cerveja.idCerveja = carrinho.idCerveja_FK";
						$resultado_consulta = mysqli_query ($conectar, $sql_consulta);
											
						echo "<p> Venda nº: $registro_idVenda[0]</p>";
						echo "<p> Data: $data</p>";
					?>
                ...
                <table class="centralizar">
                    ...
                    <?php
						$sql_registro_cerveja_venda = "INSERT INTO cerveja_venda
						(idVenda_FK,quantidade,idCerveja_FK)
						VALUES ('$registro_idVenda[0]','$registro[2]','$registro[0]')";
						
						$resultado_registro_venda = mysqli_query ($conectar, $sql_registro_cerveja_venda);

							}
						?>
                </table>
                <p> Total: <?php echo $valor_total; ?> </p>
                <p> <a href="processa_apaga_carrinho.php"> Fechar recibo </a> </p>
            </div>
