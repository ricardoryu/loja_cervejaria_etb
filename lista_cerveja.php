        ...
        <div id="conteudo_especifico">
            ...
            <div id="funcionalidade" class="div_direita">
                <?php
					...
					?>
                <p> <a href="cadastra_cerveja.php"> Cadastrar cerveja </a> </p>
                <table class="centralizar">
                    ...
                    <tr>
                        ...
                        <td class="direita">
                            <p>
                                <a href="altera_cerveja.php?codigo=<?php echo $registro[0]?>">
                                    Alterar
                                </a>
                            <form method="post" action="processa_exclui_cerv.php">
