            ...
            <div id="funcionalidade" class="div_direita">
                <?php
						...
						$sql_consulta = "SELECT
                                            cerveja.idCerveja,
                                            cerveja.nomeCerveja,
                                            cerveja_venda.quantidade,
                                            cerveja.preco
                                        FROM
                                            cerveja
                                        INNER JOIN cerveja_venda ON cerveja.idCerveja = cerveja_venda.idCerveja_FK
                                        WHERE  
                                            cerveja_venda.idVenda_FK = '$cod'";
                ...
                <p> <a href="relatorio_vendas.php"> Voltar </a> </p>
            </div>
        </div>
        <div id="rodape">
